        ...
        <div class="pietable">
          <el-row>
            <el-col :span="4" :offset="8">
              <div class="grid-content bg-purple">公司</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">小企业</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">风险</div>
            </el-col>
           <el-col :span="4">
          ...
          <el-row>
            ...
            <el-col :span="4">
              <div class="grid-content bg-purple">25亿</div>
            </el-col>
            <el-col :span="4">
              <div class="grid-content bg-purple">-2亿</div>
            </el-col>
            <el-col :span="4">
          ...
          <el-row>
            ...
            <el-col :span="4">
              <div class="grid-content bg-purple">
               <img v-if="tbzs3>0" src="../../assets/compar/redz.png" alt>
                <img v-else-if="tbzs3<0" src="../../assets/compar/blued.png" alt>
                {{tbzs3}}%
              </div>
            </el-col>
            <el-col :span="6">
              <div class="grid-content bg-purple">
               <img v-if="tbzs4>0" src="../../assets/compar/redz.png" alt>
                <img v-else-if="tbzs4<0" src="../../assets/compar/blued.png" alt>
                {{tbzs4}}%
              </div>
            </el-col>
          </el-row>
          ...
          <!-- <div class="content-table">
            ...
            <div class="content-table-right">
              <el-table
                ...
                style="width:100%"
              >
                <el-table-column class="table-tit" prop="institution" label="机构" width="80%"></el-table-column>
                <el-table-column class="table-tit" prop="costincome" label="成本收入比" width="62%"></el-table-column>
                <el-table-column class="table-tit" prop="total" label="累计费用" width="62%"></el-table-column>
                <el-table-column class="table-tit" prop="costgrowth" label="费用增速" width="62%"></el-table-column>
                <el-table-column class="table-tit" prop="amount" label="累计收入" width="62%"></el-table-column>
                <el-table-column class="table-tit" prop="incomegrowth" label="收入增速" width="62%"></el-table-column>
              </el-table>
            </div>
          </div>-->
        </div>
        ...
        series: [
          {
            ...
            // center: ["54%", "45%"],
            center: ["44%", "55%"],
           color: ["#FF6600", "#FFCC33", "#FFFFFF", "#FFFF99"], //饼图颜色
...
// /* 这里改一下代码 */
// .tab table thead th:nth-child(n + 1) {
//   /* width: 20%; */
//   padding: 0 10px;
